...
from .models import AssessmentPeriod, ManagementAreaVersion, Profile
...
@receiver(post_save, sender=AssessmentPeriod)
...
@receiver(post_delete, sender=AssessmentPeriod)
