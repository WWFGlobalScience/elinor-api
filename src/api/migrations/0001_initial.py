...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='region_mas', to='api.region'),
        ),
        migrations.AddField(
            model_name='managementarea',
            name='updated_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('role', models.PositiveSmallIntegerField(choices=[(90, 'superadmin'), (70, 'admin'), (40, 'contributor'), (10, 'observer')])),
                ('assessment_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collaborators', to='api.assessmentperiod')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessment_periods', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
